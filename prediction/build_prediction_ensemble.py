...
def main(expt_set, checkpoint_code, dataset='test', pred_chroms=['chr21'],
  ...
  for weights_name in weights_list:
    for pred_chrom in pred_chroms:
      ...
      save_model_chrom_preds(weights_name, expt_set, pred_chrom, checkpoint_code, dataset=dataset,
                             train_dataset=train_dataset, moving_average=moving_average,
...
if __name__ == '__main__':
  ...
  main(args.expt_set, args.checkpoint_code, dataset=args.dataset,
       pred_chroms=args.chrom_list, all_chroms=args.all_chroms,
