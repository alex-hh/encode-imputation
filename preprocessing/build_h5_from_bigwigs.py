...
def main(directory=None, chroms=['chr21']):
  """
  ...
  for dataset in ['train', 'val']:
    dataset_bigwigs = glob.glob(directory+'{}/*.bigwig'.format('training' if dataset=='train' else 'validation'))
...
if __name__ == '__main__':
  ...
  main(chroms=args.chrom_list, directory=args.directory)